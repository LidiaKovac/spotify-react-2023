...
import { getArtistById, getPopularAndAlbums } from "../../app/actions/artist/artist"
...
export const Artist = () => {
    const { data: artist, popular, albums, loading } = useSelector((state: RootState) => state.artist)
