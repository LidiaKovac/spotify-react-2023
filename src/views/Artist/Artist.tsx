...
import {
  getArtistById,
  getPopularAndAlbums,
} from "../../app/actions/artist/artist"
        ...
        {loading ? (
          ...
          <>
            <div className="artist__header">
              ...
              <div className="artist__header-content ms-3">
                ...
                <div className="monthly__listeners text-white fw-bold">
                  <span className="listeners">{artist.id}</span> monthly
                  listeners
                </div>
              </div>
            </div>
            ...
            <div className="container">
              ...
              <Row className="artist__popular-tracks mx-3">
                {artist.tracks?.map((song) => (
              ...
              <div className="discography__option">
                <button
                  className={`discography__option-single popular px-2 py-1 ${
                    option === "popular" ? "option--active" : ""
                  }`}
              ...
              <Row className="option__container my-2">
                {option === "popular" && popular.length > 0
                  ? popular.map((song) => (
